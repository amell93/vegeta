...
func easyjsonBd1621b8DecodeTestVegeta(in *jlexer.Lexer, out *jsonResult) {
	...
	for !in.IsDelim('}') {
		...
		case "reqBody":
			out.ReqBody = string(in.String())
		case "rspBody":
			out.RspBody = string(in.String())
		case "method":
...
func easyjsonBd1621b8EncodeTestVegeta(out *jwriter.Writer, in jsonResult) {
	...
	{
		const prefix string = ",\"reqBody\":"
		out.RawString(prefix)
		out.String(string(in.ReqBody))
	}
	{
		const prefix string = ",\"rspBody\":"
		out.RawString(prefix)
		out.String(string(in.RspBody))
	}
	{
